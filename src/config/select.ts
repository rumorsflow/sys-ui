...
import { CHAT_TYPES, JOB_NAMES } from '@/api'

export const languagesSource: ReadonlyArray<SelectItem> = [
...
export const chatTypesSource: ReadonlyArray<SelectItem> = CHAT_TYPES.map((c) => ({
  value: c,
  label: c,
}))

export const jobNameSource: ReadonlyArray<SelectItem> = JOB_NAMES.map((c) => ({
  value: c,
  label: c,
}))
